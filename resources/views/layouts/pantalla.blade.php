...
<script>
    ...
    $(function () {
        ...
        setInterval(function () {
            $('#panel2, #panel11').find('.card').toggleClass('flipped');
        }, 80000);
        setInterval(function () {
            renueva_asistencia();
        }, 80000);
    ...
    const cumpleanios_scroll = () => {
        // Llego al final del scroll
        (scroll >= document.getElementById('lista-cumpleanios').scrollHeight) ? scroll = 0 : scroll += 59;
        $("#lista-cumpleanios").stop().animate({scrollTop: scroll}, 500, 'swing');
    }
