...
<form id="informacion_personal" class="mt-4">
@csrf
    </br><h3 class="font-weight-bold" >Datos del trabajador</h3>
    <div class="form-row mt-4">
        ...
        <div class="form-group col-md-4">
            ...
            <input name="paterno" class="form-control" type="text" id="paterno" placeholder="Paterno">
        </div>
        <div class="form-group col-md-4">
            <label class="preguntaCuestionario-4" for="materno">Apellido materno: </label>
            <input name="materno" class="form-control" type="text"  id="materno" placeholder="Materno">
        </div>
    </div>
    ...
    <h3 class="font-weight-bold">Datos laborales</h3>
    <div class="form-row">
    ...
    <div class="form-row">
        ...
        <button class="button-style center" id="btn-guardar">Guardar</button>
...
$(function(){
    ...
    @if(isset($trabajador))
        ...
        @php 
            ...
            if($trabajador->sexo != "" && $trabajador->sexo != null) { echo '$("input:radio[value='. $trabajador->sexo.']").attr("checked", true);'; } 
