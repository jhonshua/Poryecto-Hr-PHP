...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <a href="{{ url('/prestaciones-inicio') }}" data-toggle="tooltip" title="Regresar"  ref="Alta prestación">
                @include('includes.back')
            </a>
            <label class="font-size-1-5em mb-5 under-line font-weight-bold">Parametría / Crear / Prestación </label>
