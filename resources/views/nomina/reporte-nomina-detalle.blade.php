...
@section('content')
    ...
    <div style="margin-top: 20px;">
        <h5>Razón social: {{Session::get('empresa')['razon_social']}}</h5>
    ...
    <tr>
        ...
        <td colspan="3">
            <table class="table table-striped mt-5 mr-3">
                ...
                <tr>
                    <td>ANTICIPO</td>
                    <td>${{ number_format(round((float) $parametros_empresa->anticipo,2),2,'.',',') }}</td>
                </tr>
                <tr>
                    <td>VACACIONES</td>
                    <td>$0.00</td>
                ...
                <tr>
                    ...
                    <td>${{ number_format(round((float) $parametros_empresa->comision_mismo_dia,2),2,'.',',') }}</td>
                </tr>
                <tr>
