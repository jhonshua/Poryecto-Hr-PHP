...
@include('calculo-nomina.reporte-nomina-detalle-include')
    ...
    <tr>
        ...
        <td colspan="3">
            <table class="table table-striped mt-5 mr-3">
                <tr>
                    <td colspan="2" style="background:#343a40; color: #ffffff; font-size:16px">DETALLE DE FACTURACIÓN</td>
                </tr>
                <tr>
                    <td>NÓMINA</td>
                ...
                <tr>
                    <td  style="background:#fbba00;"><b>TOTAL PAGO NÓMINA</b></td>
                ...
                <tr>
                    <td style="background:#fbba00;"><b>TOTAL</b></td>
