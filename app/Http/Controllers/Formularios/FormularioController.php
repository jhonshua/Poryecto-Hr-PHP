...
class FormularioController extends Controller
{
    ...
    public function agregarEncuestaCovid()
    {
        try{
            ...
            $descripcion = "Buenos días¡ Muchas gracias por su cumplimiento y responsabilidad ante las medidas de bioseguridad. Es OBLIGATORIO contestar esta encuesta 30 minutos antes de llegar a las oficinas e ingresar.";
